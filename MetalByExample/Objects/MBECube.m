...
- (void)makeBuffers {
	...
	{
		{.position = { -0.5f,  -0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, 0.0f, 6}},
		{.position = { 0.5f,  -0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, 0.0f, 6}},
		{.position = { 0.5f,  0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, 0.0f, 6}},
		{.position = { 0.5f,  0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, 0.0f, 6}},
		{.position = { -0.5f,  0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, 0.0f, 6}},
		...
		{.position = { -0.5f,  0.5f,  0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {-1.0f, 0.0f, 6}},
		{.position = { -0.5f,  0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {-1.0f, 0.0f, 6}},
		{.position = { -0.5f,  -0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {-1.0f, 0.0f, 6}},
		{.position = { -0.5f,  -0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {-1.0f, 0.0f, 6}},
		{.position = { -0.5f,  -0.5f,  0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {-1.0f, 0.0f, 6}},
		...
		{.position = { -0.5f,  -0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, -1.0f, 6}},
		{.position = { 0.5f,  -0.5f,  -0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, -1.0f, 6}},
		{.position = { 0.5f,  -0.5f,  0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, -1.0f, 6}},
		{.position = { 0.5f,  -0.5f,  0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, -1.0f, 6}},
		{.position = { -0.5f,  -0.5f,  0.5f, 1 }, .color = { 0, 0, 0, 0 }, .normal = {0.0f, -1.0f, 6}},
